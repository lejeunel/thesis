...
\supervisor{Prof. Dr. \textsc{Sznitman} Raphael} % Your supervisor's name
\coadvisor{Prof. Dr. \textsc{Favaro} Paolo} % Your examiner's name
\mentor{Prof. Dr. \textsc{Reyes} Mauricio} % Your mentor's name
...
\include{chapters/1-intro/intro}
\include{chapters/2-datasets/datasets}
\include{chapters/3-eel/eel}
\include{chapters/4-feats/main}
\include{chapters/5-ksp/main}
