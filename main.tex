...
\supervisor{Prof. Dr. \textsc{Sznitman} Raphael}
\coadvisor{Prof. Dr. \textsc{Favaro} Paolo}
\mentor{Prof. Dr. \textsc{Reyes} Mauricio}
\degree{Doctor of Philosophy in XXX}
\author{\textsc{Lejeune} Laurent}

\matriculation{04-807-897}

\subject{SUBJECT}
\keywords{keyword1, keyword2}
\university{University of Bern}
\department{Faculty of XXX}
\group{Group Name}
\faculty{Graduate School for Cellular and Biomedical Sciences}
