...
\begin{table}
  ...
  %\begin{tabularx}{\textwidth}{cccccc|ccc}
      ...
      \fatline
      \dataall{chapters/6-ksp/tables/Tweezer_self.csv}{Tweezer}
      \dataall{chapters/6-ksp/tables/Brain_self.csv}{Brain}
      \dataall{chapters/6-ksp/tables/Slitlamp_self.csv}{Slitlamp}
      \dataall{chapters/6-ksp/tables/Cochlea_self.csv}{Cochlea}
  \end{tabularx}
...
{chapters/6-ksp/tables/learning_all.csv}
