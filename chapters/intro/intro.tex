...
\textbf{Chapter 6} investigates on using a self-supervised clustering method to improve on the foreground prediction and pairwise similarity models defined in the previous chapter.
