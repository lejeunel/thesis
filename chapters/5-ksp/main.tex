...
\resetfigpath{5-ksp}
\input{chapters/5-ksp/table.tex}
\input{chapters/5-ksp/02_intro}
\input{chapters/5-ksp/03_relatedworks}
\input{chapters/5-ksp/04_methods}
\input{chapters/5-ksp/05_experiments}
\input{chapters/5-ksp/06_conclusion}
\input{chapters/5-ksp/07_appendix}
