...
\resetfigpath{4-ksp}
\input{chapters/4-ksp/table.tex}
\input{chapters/4-ksp/02_intro}
\input{chapters/4-ksp/03_relatedworks}
\input{chapters/4-ksp/04_methods}
\input{chapters/4-ksp/05_experiments}
\input{chapters/4-ksp/06_conclusion}
\input{chapters/4-ksp/07_appendix}
