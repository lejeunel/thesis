...
\thesistitle{Annotating Medical Sequences in the Blink of an Eye: Segmention of Video and Volumetric Medical Sequences at Frame-rate using Sparse Point-wise Supervision} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\matriculation{04-807-897} % Your matriculation number, this is not currently used anywhere in the template, print it elsewhere with \matriculationnum
