...
\thesistitle{Annotating Sequences in the Blink of an Eye: Sparse Point-wise Supervision for the Segmentation of Video and Volumetric Medical Sequences at Frame-rate} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
