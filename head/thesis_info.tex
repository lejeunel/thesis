...
\thesistitle{Annotating Medical Sequences in the Blink of an Eye: Segmenting Video and Volumetric Medical Sequences at Frame-rate using Sparse Point-wise Supervision} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
