...
State-of-the-art supervised Machine Learning methods, and in particular the ones grounded on Deep Learning, have already shown their superiority over traditional methods on a variety of tasks, namely classification and segmentation of images.
However, this performance boost comes at a price: As the flexibility of the models increase, machine learning practitioner need an increasing amount of annotated training examples to fully exploit that potential.
...
The present thesis provides contributions to the latter bottleneck.
...
By explicitly leveraging spatio-temporal relations between over-segmented regions, our first contribution formulates the segmentation problem as a maximum a posteriori problem.
